...
public class ObjectArrayEx10 {
	...
	public static void main(String[] args) {
		...
		int[] arr = new int[10]; // 10개 
		ArrayList<Integer> list = new ArrayList<Integer>(); // 10개 
		...
		list = null; // ArrayList자체를 삭제 
		
		list.add(10); // 2. nullpointerexception error
		
		 // 다시 10을 넣으려면 아래와 같이 생성한다. 
